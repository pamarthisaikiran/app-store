...
class AppStore extends Component {
  ...
  getSelectedApps = appsLists => {
    const {activeTabId} = this.state
    const filteredApps = appsLists.filter(
  ...
  getSearchedApp = () => {
    ...
    const Result = appsList.filter(eachItem =>
  ...
  render() {
    ...
    const Result = this.getSearchedApp()
    const filteredApps = this.getSelectedApps(Result)
